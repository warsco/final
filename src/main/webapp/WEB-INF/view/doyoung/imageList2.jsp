...
<link rel="stylesheet" type="text/css"
	href="/final/resources/src/Elastislide/css/demo.css" />
<link rel="stylesheet" type="text/css"
	href="/final/resources/src/Elastislide/css/elastislide.css" />
<link rel="stylesheet" type="text/css"
	href="/final/resources/src/Elastislide/css/custom.css" />
<style>
<!--
...
<!-- detail modal -->
 ...
 <!-- Modal -->
  <div class="modal fade" id="detail">
	...
	<figure>
	<img alt="" src="${item.filePath}" class="sel"  title="${item.num}" data-toggle="modal"data-target="#shot-modal" 
								...
								<div class="card no-margin-top">
									<div class="card-block">
										...
										<ul class="image-gallery">
											...
											<li
												data-thumb="/final/resources/src/assets/img/shot-big-2-thumb.jpg"
												data-src="/final/resources/src/assets/img/shot-big-2.jpg">
												<img
												src="/final/resources/src/assets/img/shot-big-2-thumb.jpg"
												alt="thumb">
											</li>

											<li
												data-thumb="/final/resources/src/assets/img/shot-big-3-thumb.jpg"
												data-src="/final/resources/src/assets/img/shot-big-3.jpg">
												<img
												src="/final/resources/src/assets/img/shot-big-3-thumb.jpg"
												alt="thumb">
											</li>

											<li
												data-thumb="/final/resources/src/assets/img/shot-big-4-thumb.jpg"
												data-src="/final/resources/src/assets/img/shot-big-4.jpg">
												<img
												src="/final/resources/src/assets/img/shot-big-4-thumb.jpg"
												alt="thumb">
											</li>
										</ul>
	...
	<div class="main">
		<div class="fixed-bar"  style="margin-left: 10000px" id ="choo">
...
<button class ="btn btn-primary" id="cho2">버튼이다</button>
  
 	<script type="text/javascript"
		src="http://ajax.googleapis.com/ajax/libs/jquery/1.8.2/jquery.min.js"></script>
	<script type="text/javascript"
		src="/final/resources/src/Elastislide/js/jquerypp.custom.js"></script>
	<script	src="/final/resources/src/Elastislide/js/modernizr.custom.17475.js"></script>
	<script type="text/javascript"
